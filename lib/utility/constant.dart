...
const kColorBG2 = Color(0xFF7986CB);
const kColorBG = Color.fromARGB(255, 96, 110, 181);
const kColorLogo = Color.fromARGB(255, 35, 138, 145);
const kColorContainer = Color.fromARGB(255, 201, 223, 242);
const kColorWhite = Color(0xFFFFFFFF);
const kColorWhite2 = Color(0xFFC4C4C4);
const kColorGrey = Color(0xFFC4C4C4);
const kColorGrey2 = Color(0xFFEBEBEB);
const kColorGrey3 = Color(0xC8EEEEEE);
const kColorDGrey = Color(0xFFB0BEC5);
